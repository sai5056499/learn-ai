...
const CreateCourseModal: React.FC<CreateCourseModalProps> = ({ isOpen, onClose, onGenerate, error: propError, selectedFolderId }) => {
                ...
                <div className="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            {selectedFolderId 
                                ? `What would you like to learn about in "${folders.find(f => f.id === selectedFolderId)?.name}"?`
                    ...
                    {folders.length > 0 && (
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all ${selectedFolderId ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                            >
