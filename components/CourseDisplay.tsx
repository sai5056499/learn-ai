...
import { ShareIcon, LogoIcon, ChevronLeftIcon } from '../common/Icons';
            ...
            <header className="mb-8">
                <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0 mt-12">
                        <button
                            onClick={handleShare}
                            className="flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-slate-700 rounded-lg transition-colors text-sm font-semibold border border-gray-300"
